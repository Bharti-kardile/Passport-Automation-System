...
<ul>
		  ...
		  <div>
		    <div>
              <div class="activities">
                ...
                <div>
                  <p>Renew</p><form method="post" action="Renew.jsp">
 ...
 <td><input type="text" name="t1"></td>
  ...
  <tr>
  <p align="center" class="style2"><em><td>Renew Letter</td></em> 
...
String letter=request.getParameter("t2");
String adate=request.getParameter("t3");
if(aid!=null && letter!=null&&adate!=null)
{
...
Statement st=con.createStatement();
	...
	if(rs.next())
	{
		int k =st.executeUpdate("insert  into renew values ("+aid+",'"+letter+"','"+adate+"'");
		if(k>=1)
		{
			JOptionPane.showMessageDialog(null,"renewaddsuccessfully");
		}
	}
