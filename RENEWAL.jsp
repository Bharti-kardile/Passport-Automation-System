		  ...
		  <div>
		    <div>
              <div class="activities">
                ...
                <div>
                  <h3></h3>
                  <form method="post" action="RENEWAL.jsp">
                  
                  <table><p align="center" class="style5"><strong>Accept/Reject Renewal </strong></p>
  <p align="center"><span class="style7">
  <td>Applicationid</span></td>
 <td><input type="text" name="t1"></td>
 </tr>
  </p>
  <tr>
  <p align="center" class="style2"><em><td>Message</td></em> 
    <td><input type="textarea" name="t2"></td>
  </p></tr>
  <tr>
  <p align="center" class="style2"><em><td>ApplicationDate</td></em>
    <td><input type="text" name="t3"></td>
     </tr>
  </p>
  <p align="center" class="style2"><em><td>Status</td></em>
   <td><select><option>Accepted</option><option>Rejected</option></select></td>
...
String adate=request.getParameter("t3");
String status=request.getParameter("select");
if(aid!=null && message!=null&&adate!=null&&status!=null)
{
...
Statement st=con.createStatement();
	...
	if(rs.next())
	{
		int k =st.executeUpdate("insert  into renewal values ('"+aid+"','"+message+"','"+adate+"','"+status+"'");
		if(k>=1)
		{
